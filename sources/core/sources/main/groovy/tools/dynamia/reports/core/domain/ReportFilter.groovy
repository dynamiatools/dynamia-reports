...
@Descriptor(fields = ["name", "label", "condition", "dataType", "defaultValue", "values", "queryValues", "order"], viewParams = "columns: 2")
class ReportFilter extends SimpleEntitySaaS {
    ...
    @Descriptor(params = ["multiline: true", "height: 100px", "style: 'font-family: monospace'", "span: 2"])
    String queryValues
